...
class JiuJingQi: # {{{1 JiuJingQi
    ...
    def __init__(self, config: dict = {}): # {{{1 JiuJingQi Init
        ...
        # self._Board = { # The Board of thek Heart Sample on the top
        #     "A": Jing({"owner": None, "board": [[0, 0, 0], [0, 0, 2], [0, 2, 1]]}),
        #     "B": Jing({"owner": None, "board": [[0, 0, 0], [2, 0, 2], [1, 2, 1]]}),
        #     "C": Jing({"owner": None, "board": [[0, 0, 0], [2, 0, 0], [1, 2, 0]]}),
        #     "D": Jing({"owner": None, "board": [[2, 1, 2], [0, 1, 1], [0, 0, 2]]}),
        #     "E": Jing({"owner": None, "board": [[1, 2, 1], [2, 0, 2], [1, 2, 1]]}),
        #     "F": Jing({"owner": None, "board": [[2, 1, 2], [1, 1, 0], [2, 0, 0]]}),
        #     "G": Jing({"owner": None, "board": [[0, 0, 0], [0, 0, 0], [0, 0, 0]]}),
        #     "H": Jing({"owner": None, "board": [[2, 1, 2], [0, 2, 0], [0, 0, 0]]}),
        #     "I": Jing({"owner": None, "board": [[0, 0, 0], [0, 0, 0], [0, 0, 0]]}),
        # }
        self._History = {1: [], 2: []}
        self._Move = {1: [], 2: []}
