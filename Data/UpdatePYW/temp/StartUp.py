...
files = {
    "WeMeetApp": ["os", "D:/Program Files/Tencent/WeMeet/wemeetapp.exe"],
    "WeChat": ["os", "D:/Program Files/WeChat/WeChat.exe"],
    "TIM": ["o", "D:/Program Files/TIM/Bin/QQScLauncher.exe"]
}
...
while True:
    ...
    if now in "12345":
        for key, value in files.items():
            SignIn(value[0], value[1], target + key + ".png")
        break